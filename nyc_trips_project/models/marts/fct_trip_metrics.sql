...
with base as (
    ...
    -- excludes TLC's reserved/placeholder zones (264=Unknown, 265=Outside NYC)
    -- and deprecated zone IDs no longer present in the current taxi_zone_geom lookup (105, 57)
      and pickup_location_id not in ('105', '264', '57', '265')
      and dropoff_location_id not in ('105', '264', '57', '265')
